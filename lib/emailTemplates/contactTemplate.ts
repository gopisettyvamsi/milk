export function createEmailTemplate(data: {
    ...
    const { firstName, lastName, email, phone, company, helpOption, message } = data;
        ...
        <div class="container">
          ...
          <div class="content">
            <div class="contact-info">
              <div class="field-group">
                ...
                <div class="field-value">${firstName || 'Not provided'}</div>
              </div>
              
              <div class="field-group">
                <span class="field-label">Last Name:</span>
                <div class="field-value">${lastName || 'Not provided'}</div>
              </div>
            </div>
            ...
            <div class="contact-info">
              ...
              <div class="field-group">
                <span class="field-label">Help Option:</span>
                <div class="field-value">${helpOption || 'Not specified'}</div>
              </div>
            </div>
          ...
          <div class="footer">
            <p>
              ...
              Please respond to <strong>${email}</strong> to continue the conversation.
            </p>
          </div>
        </div>
      </body>
